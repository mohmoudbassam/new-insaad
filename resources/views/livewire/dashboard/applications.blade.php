<section id="basic-datatable">
    <div class="row">
        @include("dashboard.application.partials.filter")
            ...
            <div class="card">
                <table class="datatables-basic table">
                    ...
                    <tr>
                        ...
                        <th>{{trans('dashboard.main.email')}}</th>
                    ...
                    @foreach($applications as $application)
                        <tr @if($loop->odd) class="odd" @endif >
                            ...
                            <td>
                                @can('view content')
                                    <a href="{{route('applications.show' , ['lang' => app()->getLocale(), 'application' => $application])}}"
                                       class="text-primary mr-2">
                                        <i data-feather='eye'></i>{{trans('application.show')}}
                                    </a>
        ...
        <div class="col-12">
            {{ $applications->links("vendor.livewire.bootstrap-livewire") }}
        </div>
    </div>

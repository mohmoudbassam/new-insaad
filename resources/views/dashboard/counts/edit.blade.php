                                ...
                                <div class="breadcrumb-wrapper">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item ">
                                            <a
                                                    href="{{route('counts.index',['lang' => app()->getLocale()])}}">  {{trans('dashboard.count.count')}}</a>
                                        </li>
            ...
            <div class="content-body  ">
                ...
                <section id="basic-vertical-layouts">
                    <form class="form form-vertical needs-validation " method="POST" id="addRoleForm"
                          action="{{route('counts.update',['lang' => app()->getLocale(),'count'=>$count])}}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" id="first-name-icon" class="form-control
                                                                @error("name") is-invalid @enderror"
                                                                   name="{{ $key }}[name]"
                                                                   value="{{ $count->translate($key)->name }}" required>
                                                            @error("$key.name")
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" id="first-name-icon" class="form-control
                                                                @error("item") is-invalid @enderror"
                                                                   name="{{ $key }}[item]"
                                                                   value="{{ $count->translate($key)->item }}" required>
                                                            @error("$key.item")
                                                            <div class="text-danger">
                                                                {{ $message }}
                                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                           for="first-name-icon">{{trans("dashboard.footer.link")}}</label>
                                                    <div class="input-group input-group-merge">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <input type="file" name="image" class="dropify"  data-max-file-size="1M"
                                                                   data-default-file="{{ asset( optional($count->image)->image) }}"/>
                                                            @error("image")
                                                            <div class="text-danger">
                                                                {{ $message }}
                                                            </div>

            ...
            <div class="content-body">
                ...
                <section id="basic-vertical-layouts">
                    <form class="form form-vertical needs-validation" method="POST"
                          action="{{route('articles.update',['lang' => app()->getLocale()])}}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" class="form-control
                                                               ...
                                                               name="title_ar"
                                                               value="{{$article->getTranslation('title','ar')}}"
                                                               required>
                                                        @error("title_ar")
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" class="form-control
                                                               ...
                                                               name="title_en"
                                                               value="{{$article->getTranslation('title','en')}}"
                                                               required>
                                                        @error("title_en")
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                        ...
                                        <textarea type="text" id="description_ar" class="form-control editor"
                                                  name="description_ar"
                                                  placeholder="{{__('dashboard.main.description_ar')}}">{!! $article->getTranslation('description','ar') !!}</textarea>
                                        ...
                                        <textarea type="text" id="description_en" class="form-control editor"
                                            ...
                                            <div class="col-3">
                                                <img src="{{asset('storage/'.$article->image)}}" alt="site logo" style="width: 80px; height: auto; border-radius: 50%;margin: 20px auto">
                                            </div>
                                            <div class="col-12">
                                                <button type="submit"

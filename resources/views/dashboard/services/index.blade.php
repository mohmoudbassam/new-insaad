...
@section("title")
    {{__('dashboard.services.services')}}
@endsection
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> {{__('dashboard.services.services')}}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
{{--                        <a href="{{route('services.create',['lang' => app()->getLocale()])}}" class="btn btn-success btn-rounded m-1 float-right">--}}
{{--                            <i data-feather='plus'></i>   {{__('dashboard.services.add service')}}</a>--}}
{{--                    </div>--}}
{{--                </div>--}}
            </div>
